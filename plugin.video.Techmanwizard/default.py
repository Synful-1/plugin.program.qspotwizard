...
base='https://github.com/Synful-1/repository.qspot'
ADDON=xbmcaddon.Addon(id='plugin.video.Techmanwizard')
...
def CATEGORIES():
    link = OPEN_URL('https://github.com/Synful-1/Synful-1.github.io/blob/master/Wizard/wizard.html').replace('\n','').replace('\r','')
